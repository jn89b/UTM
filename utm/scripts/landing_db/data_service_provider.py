...
if __name__ == '__main__':
    ...
    try:
        ...
        uav_2 = TestUAV("uav2",[[-40, 10, 10],[0,0,0,1]],[[0, 5, 10],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
        ...
        uav_6 = TestUAV("uav6",[[0, 100, 10],[0,0,0,1]],[[49, 0, 10],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
