...
if __name__ == '__main__':
    ...
    try:
        uav_0 = TestUAV("uav0",[[-10, 20, 10],[0,0,0,1]],[[0, 0, 10],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
        uav_1 = TestUAV("uav1",[[-20, 0, 10],[0,0,0,1]],[[0, 10, 10],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
        uav_2 = TestUAV("uav2",[[-10, 10, 10],[0,0,0,1]],[[0, 5, 10],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
        uav_3 = TestUAV("uav3",[[-30, -40, 10],[0,0,0,1]],[[0, 15, 7],[0,0,0,1]], [[10, -123, 100],[0,0,0,1]], 82,True)
