...
class Controller
{
    ...
    public:
        Controller()
        {
            ...
            nh.getParam("offboard_landing/offset_x", offset_x);
            nh.getParam("offboard_landing/offset_y", offset_y);
            
            nh.getParam("offboard_landing/init_x", init_x);
            nh.getParam("offboard_landing/init_y", init_y);
            nh.getParam("offboard_landing/init_z", init_z);
            //services
    ...
    void pre_land_protocol(Eigen::Vector2d gain, float drop_down_val)
    {
        ...
        pose.pose.position.y = odom_y; // pretty much keep at where we are 
...
{
    ros::init(argc, argv, "offboard_landing_v2");
    Controller control;
