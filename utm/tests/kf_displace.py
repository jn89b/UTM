...
class KalmanFilter():
    def __init__(self, F = None, B = None, H = None, Q = None, R = None, P = None, x0 = None):
        ...
        rospy.Subscriber("/displace/tag/pose", PoseStamped, self.tagpose_cb)
        
        self.kf_pub = rospy.Publisher("uav0/displace/tag/kfpose", PoseStamped, queue_size=20)        
        self.P_pub = rospy.Publisher("uav0/displace/P_covar/pose", PoseStamped, queue_size=20)
    ...
    def update_R(self):
        ...
        if self.z_height != None:
            R_factor = ((0.0232*self.z_height + 0.0295)**2)*2
